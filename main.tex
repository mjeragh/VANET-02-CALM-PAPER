...
% TODO: Week 7 — fill in detailed results narrative

\subsection{NGSIM Action Agreement}

Table~\ref{tab:agreement} summarizes the NGSIM action agreement across all methods.
...
Table~\ref{tab:significance} presents pairwise statistical comparisons.
...
Fig.~\ref{fig:comparison} shows the combined comparison of all methods across agreement, entropy, and reward metrics.
...
% TODO: Add detailed per-metric analysis, learning curves, and qualitative examples.
...
% TODO: Expand with practical implications and deployment considerations.

\subsection{Limitations}

% TODO: Discuss simulation-to-real gap, NGSIM limitations, scalability beyond 5 agents.

% ============================================================
\section{Conclusion}
\label{sec:conclusion}

% TODO: Week 7 — full conclusion

We presented CALM, a constrained actor-learning approach that prevents mode collapse in MARL for cooperative driving by anchoring policies to human demonstrations via decaying KL regularization. Our theoretical analysis provides entropy lower bounds under the CALM constraint, and our 25-run statistical study demonstrates that CALM and its variants successfully eliminate mode collapse while DAgger achieves the highest human-likeness. Future work will address scalability to larger agent populations and transfer to real-world V2X systems.
